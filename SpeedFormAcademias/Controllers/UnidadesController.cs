...
namespace SpeedFormAcademias.Controllers
{
    public class UnidadesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Localizacao,LocalizacaoFoto")] Unidade unidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Localizacao,LocalizacaoFoto")] Unidade unidade)
        {
            if (id != unidade.Id)
            {
                return NotFound();
