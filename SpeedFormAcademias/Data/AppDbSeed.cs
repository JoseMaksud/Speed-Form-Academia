    ...
    public AppDbSeed(ModelBuilder builder)
    {
        ...
        List<Modalidade> modalidades = new() {
            new Modalidade() {
                ...
                Imagem = @"img/modalidades/1.png",
                Imagem2 = @"img/modalidades/2.png",
            },
            new Modalidade() {
                Id = 2,
                 Nome = "Spinning",
                ...
                Imagem = @"img/modalidades/3.png",
                Imagem2 = @"img/modalidades/4.png",
            },
            new Modalidade() {
                Id = 3,
                Nome = "Musculação",
            ...
            new Modalidade() {
                ...
                Imagem = @"img/modalidades/9.png",
                Imagem2 = @"img/modalidades/10.png",
            },
            new Modalidade() {
                Id = 6,
                Nome = "Aeroboxe",
                ...
                Imagem = @"img/modalidades/11.png",
                Imagem2 = @"img/modalidades/12.png",
            },
            new Modalidade() {
                Id = 7,
                Nome = "Zumba",
                ...
                Imagem = @"img/modalidades/13.png",
                Imagem2 = @"img/modalidades/14.png",
            },
            new Modalidade() {
                Id = 8,
                Nome = "Ritmo",
                ...
                Imagem = @"img/modalidades/15.png",
                Imagem2 = @"img/modalidades/16.png",
            }
        };
        ...
        for (int i = 1; i <= 2; i++)
            unidadeFotos.Add(new UnidadeFoto()
            {
                Id = i,
                UnidadeId = i,
                ArquivoFoto = $"/img/unidades/{i}/1.png",
                Destaque = true
            });
        unidadeFotos.Add(new UnidadeFoto()
        {
            Id = 3,
            UnidadeId = 1,
            ArquivoFoto = @"/img/unidades/1/2.png",
            Destaque = false
        });
        unidadeFotos.Add(new UnidadeFoto()
        {
            Id = 4,
            UnidadeId = 1,
            ArquivoFoto = $"/img/unidades/1/3.png",
            Destaque = false
        });
        unidadeFotos.Add(new UnidadeFoto()
        {
            Id = 5,
            UnidadeId = 1,
            ArquivoFoto = $"/img/unidades/1/4.png",
            Destaque = false
        });
        unidadeFotos.Add(new UnidadeFoto()
        {
            Id = 6,
            UnidadeId = 2,
            ArquivoFoto = @"/img/unidades/2/2.png",
            Destaque = false
        });
        unidadeFotos.Add(new UnidadeFoto()
        {
            Id = 7,
            UnidadeId = 2,
            ArquivoFoto = $"/img/unidades/2/3.png",
            Destaque = false
        });
        unidadeFotos.Add(new UnidadeFoto()
        {
            Id = 8,
            UnidadeId = 2,
            ArquivoFoto = $"/img/unidades/2/4.png",
            Destaque = false
        });
